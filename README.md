...
# NEWS: WE KNEW HOW IT COMEBACKS EVERY SECS SO WAIT FOR NEW UPDATE!
...
- Use malwarebytes realtime protection to find a dangerous domain or IP
- Open EXO Blocker.bat and grant administrator priveleges
- Enter the URL or IP and press Enter
- EXO Blocker will block the domain or IP and flush dns

### Defendrix
<sup> A custom User-Mode [Ring 3] anti-virus built to detect persistent programs and low-level RATs [Remote Access Trojan] quickly </sup>
